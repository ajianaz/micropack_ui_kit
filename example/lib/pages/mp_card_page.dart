        ...
        child: Column(
          ...
          children: [
            ...
            MPCard.withSections(
              ...
              body: Padding(
                padding: EdgeInsets.all(16),
                child: MPText('This card demonstrates both structured header and footer sections.'),
              ),
              footerData: MPCardFooterData(
            ...
            MPCard(
              ...
              body: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 8),
                  MPText('This card has overflow handling enabled for long content.'),
                  SizedBox(height: 8),
                  ...List.generate(
                      10,
                      (index) => Padding(
            ...
            MPCard.withSections(
              ...
              body: Padding(
                padding: EdgeInsets.all(16),
                child: MPText('This card uses responsive configuration to adapt layout based on screen size.'),
              ),
              footerData: MPCardFooterData(
                actions: [
                  TextButton(
            ...
            MPCard.withSections(
              ...
              body: Padding(
                padding: EdgeInsets.all(16),
                child: MPText('This card demonstrates responsive grid layout that adjusts column count based on screen size.'),
              ),
              footerData: MPCardFooterData(
                actions: [
                  TextButton(
